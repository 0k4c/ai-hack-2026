...
3人で同時に進めている間は、[担当ファイル・開始手順・AIへの依頼文](docs/parallel-work.md) を先に確認してください。
...
**Draft PRは着手したその日に作る。完成してから作らない。** 途中で中断するとき・セッションを終えるとき・担当を渡すときは、引き継ぎメモをPR本文かIssueコメントに書いてから離れる。書式と理由は [共通開発ルールの「作業の保存と引き継ぎ」](AGENTS.md#作業の保存と引き継ぎ) にある。
